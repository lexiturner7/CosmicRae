...
//       <div class="distance-visual-label">
//         <span>🌍 Earth</span>
//         <span>Distance relative to Moon (1 LD)</span>
//       </div>
//       <div class="distance-track">
//         <div class="moon-marker" style="left: 2%">
//           <div class="moon-label">🌙 1 LD</div>
//         </div>
//         <div class="distance-fill" style="width: ${Math.min((parseFloat(asteroid.close_approach_data[0].miss_distance.lunar) / 50) * 100, 100)}%; background: ${asteroid.is_potentially_hazardous_asteroid ? "rgba(239,68,68,0.6)" : "rgba(34,197,94,0.5)"}"></div>
//       </div>
//     </div>
